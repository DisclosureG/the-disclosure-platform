...
// The official MetaMask "fox" mark, transcribed verbatim from MetaMask's own
// asset (metamask-extension → app/images/logo/metamask-fox.svg). Full-colour
// origami fox, so it lives apart from the mono stroke icons in Icons.tsx.
// viewBox is 35×33; height is derived to keep the true aspect ratio.
export const MetaMaskFox: React.FC<{ size?: number; style?: React.CSSProperties }> = ({
  size = 96,
  style,
}) => (
  <svg
