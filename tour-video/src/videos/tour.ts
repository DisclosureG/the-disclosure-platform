...
import { TOUR_SOUND } from "./tour.audio";
...
export const TOUR: VideoConfig = {
  ...
  scenes: buildScenes(voiceover, FPS, {
    ...
    wallet: {
      ...
      props: {
        kicker: "Why a wallet?",
        headline: "MetaMask is just *your signature.*",
        brandName: "MetaMask",
        brandSub: "your wallet",
        lead: "Not a bank, not an account — just a way to sign that only you can do.",
        points: [
          { icon: "pen", title: "It proves it's really you", sub: "Every action is signed from your own wallet.", color: c.coralDeep, soft: c.coralSoft },
          { icon: "lockOpen", title: "Nothing to sign up for", sub: "No password, no email, no account to make.", color: c.sky, soft: c.skySoft },
          { icon: "shieldCheck", title: "You stay in control", sub: "We never hold your keys — or a cent of your money.", color: c.good, soft: c.sageSoft },
        ],
      },
    },
    ...
    outro: {
      kind: "outro",
      props: {
        brand: "The Disclosure Platform",
        tagline: "Kept by many · Owned by no one",
        url: "thedisclosureplatform.com",
      },
    },
  }),
