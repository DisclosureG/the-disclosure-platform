...
\title{
  ...
  {\Large The Web3 social network for contested truth --- an open\\
   archive that hands the scientific method back to the\\
   public and builds an evidence-backed, evolving reality}
}
...
the social network reclaimed for the thing social networks were supposed
to be \emph{for}. Anyone may read it. Anyone may file into it. But a claim
never floats free: it is filed \emph{against} the record that supports it
--- a paper, a book, a declassified file, a sworn testimony --- and a named
network of verified peers then judges that record in the open, by majority
vote, signing each verdict with their own cryptographic key, in a place no
one can quietly edit. No likes. No feed. No ads. No owner who can sell it,
...
what is left is not less than a social platform. It is the part of a social
platform that was always supposed to matter: a shared, durable, inspectable
account of what we have reason to believe.
...
\textbf{No anonymity for judges.} Anyone may read the archive, and anyone
may file evidence into it --- those doors are open to the world. But the
people who \emph{judge} the evidence are named. A peer carries a handle and
signs every vote with their own cryptographic key. There are no anonymous
moderators deleting records in the dark. If a record is canonized,
contested, or retired, you can see who stood behind that decision and what
they put their name to. Accountability here is not a policy that can be
quietly suspended; it is the physical shape of the system.
...
\begin{notebox}
\textbf{The whole thing, finally.} A public record room for contested truth,
where evidence is filed against its source, judged in the open by a majority
of named peers, kept where no one can quietly edit it, owned by no one and
seizable by no one, and revised forever as the evidence changes. The
scientific method, handed back to the public. The social network, reclaimed
for the truth. A labour of love --- and an open invitation to help build it.
\end{notebox}
