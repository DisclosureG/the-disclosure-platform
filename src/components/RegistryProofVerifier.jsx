...
function RegistryVerifierModal({ r, actorName, actionLabel, onClose, onLinkback, handleMap }) {
    ...
    <div className="av-backdrop is-open" onClick={onClose}>
      <div className="av-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="av-steps">
          ...
          >
            {isConsensus ? (
              <DerivationPanel descriptor={descriptor} onLinkback={onLinkback} handleMap={handleMap} />
            ) : sig ? (
              <>
...
export default function RegistryProofVerifier({ r, actorName, actionLabel, onLinkback, handleMap }) {
  ...
  return (
    <>
      ...
      {open && <RegistryVerifierModal r={r} actorName={actorName} actionLabel={actionLabel} onClose={() => setOpen(false)} onLinkback={onLinkback} handleMap={handleMap} />}
    </>
  );
}
